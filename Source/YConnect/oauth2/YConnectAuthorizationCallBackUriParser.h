...
typedef void (^YConnectHybridCallbackUriHandler)(NSString *authorizationCode, YConnectBearerToken *accessToken, NSString *idToken, NSError *error);
...
+ (void)parseHybridCallbackUri:(NSURL *)callbackUri uriScheme:(NSString *)uriScheme state:(NSString *)state handler:(YConnectHybridCallbackUriHandler)handler;
@end
